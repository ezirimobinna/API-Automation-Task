...
public class UseraccountLoginTests {
    ...
    public void loginTest() throws InterruptedException {
        //Click on the username field and input a valid username "ezirimobinna@mail.com"
        driver.findElement(By.id("email")).sendKeys("ezirimobinna@gmail.com");
        //locate the email field and use your own valid password "ezirimobinna06"
        driver.findElement(By.id("pass")).sendKeys("ezirimobinna06");
    ...
    public void logoutTest() throws InterruptedException {
        ...
        if(driver.getCurrentUrl().contains("https://www.facebook.com/?stype=lo&jlou=Afckd7_LwkxsXGYj9wNiARwuDjFutjt_7USxX5i-Jfm4zGLwKRPvGXnHRvDI8gB-qdaPhsejWAE0d4n1SgW_l2l6bKSypz1MoNX36Jf9VUZ-ug&smuh=2975&lh=Ac9_wbusuTcNFwHExus")) {
